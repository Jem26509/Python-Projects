  ...
  while True:
      ...
      if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
          ...
          """cv2.line(
              gray, 
              (int(top[0] * webcam.width()), int(top[1] * webcam.height())),
              (int(bottom[0] * webcam.width()), int(bottom[1] * webcam.height())),
              (0, 255, 0), 3
          )"""

          cv2.circle(gray, (int(top[0] * webcam.width()), int(top[1] * webcam.height())), 8, (0,0,255), -1)
          cv2.circle(gray, (int(bottom[0] * webcam.width()), int(bottom[1] * webcam.height())), 8, (0,0,255), -1)          
